Title of the project::Getting and Cleaning Data Project

Description:
This is basicaly to provide the information on the variables, data and transformations(logics) used in the course project.
...
We have the following information for each record:
...
Section 1. Merge the test and the train data sets to create one data set.
